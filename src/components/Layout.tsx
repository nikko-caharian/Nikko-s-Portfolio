    ...
    <div className="min-h-screen selection:bg-gold/30">
      ...
      <section id="contact" className="bg-white py-32 px-[5vw] flex justify-center">
        <motion.div
          ...
          className="relative w-full max-w-[860px] bg-black rounded-[40px] px-8 py-20 md:py-24 flex flex-col items-center text-center overflow-hidden"
        >
          ...
          <p className="relative z-10 text-white/50 text-lg font-light max-w-[440px] mb-10 leading-relaxed">
            Let's talk about what you need off your plate — and how I can make it disappear with precision.
          </p>
